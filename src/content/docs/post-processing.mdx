...
> For a detailed step-by-step guide on setting up a local post-processing model with LM Studio (including model configuration and inference settings), see [How to Post-Process Your Handy Speech-to-Text Transcripts Locally with LM Studio](https://kritrim.xyz/posts/3/3handypostprocess/).
