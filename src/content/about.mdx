...
Handy is a starting point for when you need accessibility features, want to experiment with voice computing, or just prefer tools you can actually own and modify. The project is designed to be tiny and extensible. It is opinionated and you might have feature requests that I will not accept, but you are more than welcome to implement them yourself. And with the help of Claude Code and Agentec Coding Tools, you might just be able to without any programming experience.
...
* [Display a noth or capsule while recording](https://github.com/cjpais/Handy/issues/39)
